                ...
                <Col lg='12'>
                    ...
                    <div className="mt-4">
                        ...
                        <div className="cart__page-btn">
                            <button className="addToCart__btn me-4"><Link to='/products'>
                                Continue Shopping</Link></button>
                                <button className="addToCart__btn"><Link to='/login'>
...
const Tr = props=>{
    ...
    return <tr>
        <td className="text-center cart__img-box"><img src={image01} alt="img" /></td>
        <td className="text-center">{title}</td>
        <td className="text-center">${price}</td>
        <td className="text-center">{quantity}px</td>
        <td className="text-center cart__item-delete"><i class="ri-delete-bin-line" onClick={deleteItem}></i></td>
