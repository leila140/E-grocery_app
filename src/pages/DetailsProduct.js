                ...
                <Row>
                    ...
                    <Col lg="12">
                        <div className="tabs d-flex align-items-center gap-5 py-3">
                            <h6 className={`${tab=='desc'? 'tab__active':''}`} onClick={()=>
                            setTab('desc')}>Description</h6>
                                
                            <h6 className={`${tab=='rev'? 'tab__active':''}`} onClick={()=>
                            setTab('rev')}>Review</h6>
                        </div>
                        {
                    ...
                    </Col>
                    {
                        relatedProduct.map(item=>(
                            <Col lg='3' md='4' sm='6' className="mb-4" xs='6' key={item.id}>
